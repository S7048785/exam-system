...
export const usePaperListStore = create<PaperListState>()((set) => ({
  ...
  dialogInitialStep: 0,
  addPaper: () =>
    set({ dialogMode: 'create', editPaperId: undefined, dialogOpen: true, dialogInitialStep: 0 }),
  editPaperAtStep: (id: number, step: number) =>
    set({ dialogMode: 'edit', editPaperId: id, dialogOpen: true, dialogInitialStep: step }),
