...
import {papersQueryOptions} from './paperQueries'
import {useChangeStatus, useDeleteMutation,} from '#/features/admin/papers/usePaperActions.ts'
...
export default function PapersPage() {
  ...
  // 列表筛选条件
  const [filters, setFilters] = useState<{ name?: string; status?: PaperStatus }>({
    name: undefined,
    status: undefined,
  })
