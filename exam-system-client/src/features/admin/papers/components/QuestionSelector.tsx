    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-end gap-3">
        <div className="space-y-1.5">
          ...
          <select
            className="flex h-9 w-[140px] rounded-md border border-input bg-background px-3 py-1 text-sm"
            value={filters.type ?? ''}
            onChange={(e) =>
              ...
              filteredQuestions.map((question) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      <span
                        className={`text-xs px-2 py-0.5 rounded ${difficultyInfo.className}`}
                      >
