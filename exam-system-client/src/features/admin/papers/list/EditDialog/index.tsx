...
export default function PaperInfoDialog() {
  ...
  const dialogOpen = usePaperListStore((state) => state.dialogOpen)
  const dialogMode = usePaperListStore((state) => state.dialogMode)
  const setDialogOpen = usePaperListStore((state) => state.setDialogOpen)
  const editPaperId = usePaperListStore((state) => state.editPaperId)
