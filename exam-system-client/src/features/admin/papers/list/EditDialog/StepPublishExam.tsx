	...
	return (
			<div className="flex h-full flex-col gap-6 px-40">
				<div>
					...
					<div className="flex items-center gap-2 border p-8 shadow-md">
						<Field>
							<ButtonGroup>
								<div
										className="border-b-input placeholder:text-muted-foreground focus-visible:border-b-ring inline-flex h-10 w-full min-w-0 items-center border bg-transparent py-1 ps-4 caret-transparent transition-[color,border-color] outline-none">
									<a
											href={examUrl}
											target="_blank"
											style={{color: '#128beb'}}
