              ...
              <div className="grid grid-cols-5 gap-2">
                {questions.map((q, i) => (
                  <button
                    ...
                    className={cn(
                      'flex size-10 items-center justify-center rounded border text-sm font-medium transition-colors',
                      activeIndex === i
            ...
            <div className="flex gap-2">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start">
                  <DropdownMenuItem
                    onClick={() => setCreateConfig({ type: 'SINGLE_CHOICE' })}
                  >
                    单选题
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={() => setCreateConfig({ type: 'MULTIPLE_CHOICE' })}
                  >
                    多选题
                  </DropdownMenuItem>
                  <DropdownMenuItem
