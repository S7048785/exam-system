...
export default function BannersPage() {
	...
	const addMutation = useMutation({
		mutationFn: (banner: BannerSaveInput) => api.bannerController.addBanner({body: banner}),
		onSuccess: () => {
	...
	const updateMutation = useMutation({
		mutationFn: (banner: BannerSaveInput) => api.bannerController.updateBanner({body: banner}),
		onSuccess: () => {
			queryClient.invalidateQueries({queryKey: ['bannerAll']})
		},
	})
