...
export default function TableCellViewer({open, item, setOpen, onSubmit}: TableCellViewerProps) {
	...
	return (
			<Drawer direction={isMobile ? 'bottom' : 'right'} open={open} onClose={() => setOpen(false)}>
				<DrawerContent>
								...
								<form.Field
										...
										children={(field) => (
												<>
													...
													<Input onDrag={(e) => e.preventDefault()} id="header" value={field.state.value}
								...
								<form.Field
										...
										children={(field) => (
												<>
													...
													<Input id="description" value={field.state.value}
																 onBlur={field.handleBlur}
																 onChange={(e) => field.handleChange(e.target.value)}/>
												</>
										)}
								...
								<form.Field
										...
										children={(field) => (
												<>
													...
													<Input id="linkUrl" value={field.state.value}
																 onBlur={field.handleBlur}
																 onChange={(e) => field.handleChange(e.target.value)}/>
												</>
										)}
								...
								<form.Field
										...
										children={(field) => (
												<>
													...
													<Input id="sortOrder" type={"number"} min={0} value={field.state.value}
																 onBlur={field.handleBlur}
								...
								<form.Field
										...
										children={(field) => (
												<>
													...
													<Select value={field.state.value === true ? 'true' : 'false'}
																	onValueChange={(e) => field.handleChange((e.valueOf() === 'true'))}>
								...
								<form.Field
										...
										children={(field) => (
												<>
													...
													<BannerImageUpload value={field.state.value} onChange={field.handleChange}/>
												</>
										)}
								/>
							</div>
