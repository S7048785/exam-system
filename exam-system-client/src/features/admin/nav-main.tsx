...
export function NavMain({
	...
	const [expanded, setExpanded] = useState<string | null>(currentParentTitle ?? null)
...
// 判断当前路由是否匹配某个路径
	...
	// 基础样式抽离，避免重复
	const activeStyles = "min-w-8 bg-primary duration-200 ease-linear hover:bg-primary/90!"
	// 有子菜单的情况
	if (item.submenu) {
		return (
				<SidebarMenuItem>
