    ...
    <Dialog open={props.open} onOpenChange={handleOpenChange}>
      <DialogContent showCloseButton={false}>
        ...
        <div className="p-5 pt-0 space-y-6 ">
          <div className="p-4 island-shell space-y-2 rounded-lg">
          ...
          <form onSubmit={props.onExamStart} className="">
            <div className="grid grid-cols-[2fr_8fr] gap-2 mb-4 items-center">
              <div className="">
              ...
              <div className="flex items-center">
                ...
                <div
                  aria-live="polite"
                  className="pointer-events-none absolute inset-e-5 flex items-center justify-center pe-3 text-muted-foreground text-xs tabular-nums peer-disabled:opacity-50"
                  id={`${id}-description`}
                  role="status"
                >
          ...
          <Alert className="mx-auto border-amber-200 bg-amber-50 text-amber-900 dark:border-amber-900 dark:bg-amber-950 dark:text-amber-50">
            <AlertTriangleIcon />
            <AlertTitle className="font-bold mb-2">考试规则</AlertTitle>
            <AlertDescription>
