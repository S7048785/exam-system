...
object PromptConstant {
    ...
    //  题目评分系统提示
    const val QUESTION_GRADE_USER_PROMPT = """
    ...
    const val QUESTION_GENERATE_SYSTEM_PROMPT = "你是一个专业的题目出题专家，严格按用户要求生成高质量题目。"

    // 题目生成用户提示
    const val QUESTION_GENERATE_USER_PROMPT = """
    ...
    const val QUESTION_CHOICE_GENERATE_USER_PROMPT = """
                **选择题特别要求**:
                1. 每个选项的权重相同，不能有空选项。
                2. 选择题包含单选和多选。
    ...
    const val QUESTION_JUDGE_GENERATE_USER_PROMPT = """
                **判断题特别要求**:
    ...
    const val QUESTION_TEXT_GENERATE_USER_PROMPT = """
                **简答题特别要求**:
